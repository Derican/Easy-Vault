...
public class TreasureGoblinModel extends PlayerModel<TreasureGoblinEntity> {
    public TreasureGoblinModel() {
        ...
        final ModelRenderer ear6_r1 = new ModelRenderer(this);
        ...
        final ModelRenderer ear5_r1 = new ModelRenderer(this);
        ...
        (this.body = new ModelRenderer(this, 16, 16)).setPos(0.0f, 0.0f, 0.0f);
        this.body.addBox(-4.0f, 0.0f, -2.0f, 8.0f, 12.0f, 4.0f);
        this.body.setPos(0.0f, 0.0f, 0.0f);
        (this.rightArm = new ModelRenderer(this, 40, 16)).addBox(-3.0f, -2.0f, -2.0f, 4.0f, 12.0f, 4.0f);
        this.rightArm.setPos(-5.0f, 2.0f, 0.0f);
        this.leftArm = new ModelRenderer(this, 40, 16);
        this.leftArm.mirror = true;
        this.leftArm.addBox(-1.0f, -2.0f, -2.0f, 4.0f, 12.0f, 4.0f);
        this.leftArm.setPos(5.0f, 2.0f, 0.0f);
        (this.rightLeg = new ModelRenderer(this, 0, 16)).addBox(-2.0f, 0.0f, -2.0f, 4.0f, 12.0f, 4.0f);
