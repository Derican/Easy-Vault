...
public class ConsumablesConfig extends Config {
    ...
    protected void reset() {
        ...
        final ConsumableEntry cobaltAppleEntry = new ConsumableEntry("the_vault:cobalt_apple", false, 0.0f, ConsumableType.BASIC).addEffect(new ConsumableEffect("minecraft:fire_resistance", 1, 2400).showIcon()).addEffect(new ConsumableEffect("minecraft:feather_feet", 1, 2400).showIcon());
