...
public class TalentsConfig extends Config {
    ...
    public List<TalentGroup<?>> getAll() {
        return Arrays.asList(this.HASTE, this.RESISTANCE, this.STRENGTH, this.FIRE_RESISTANCE, this.SPEED, this.WATER_BREATHING, this.WELL_FIT, this.TWERKER, this.ELVISH, this.CARELESS, this.ANGEL, this.REACH, this.EXPERIENCED, this.PARRY, this.STONE_SKIN, this.UNBREAKABLE, this.CRITICAL_STRIKE, this.LOOTER, this.CHUNKY, this.FRENZY, this.STEP, this.ARTISAN, this.TREASURE_HUNTER, this.BREAKABLE, this.LUCKY_ALTAR, this.FATAL_STRIKE, this.FATAL_STRIKE_CHANCE, this.FATAL_STRIKE_DAMAGE, this.THORNS, this.THORNS_CHANCE, this.THORNS_DAMAGE, this.GLASS_CANNON, this.COMMANDER, this.WARD, this.BARBARIC, this.SOUL_HUNTER, this.BARRIER);
    }
    ...
    protected void reset() {
        ...
        this.REACH = TalentGroup.ofAttribute("Reach", ForgeMod.REACH_DISTANCE.get(), "Maximum Reach", 10, i -> 1, i -> i * 1.0, i -> AttributeModifier.Operation.ADDITION);
        ...
        this.ELVISH = new TalentGroup<ElvishTalent>("Elvish", new ElvishTalent(10));
        this.CARELESS = new TalentGroup<CarelessTalent>("Careless", new CarelessTalent(3));
        this.ANGEL = new TalentGroup<AngelTalent>("Angel", new AngelTalent(200));
        this.EXPERIENCED = new TalentGroup<ExperiencedTalent>("Experienced", new ExperiencedTalent(2, 0.2f), new ExperiencedTalent(2, 0.4f), new ExperiencedTalent(2, 0.6f), new ExperiencedTalent(2, 0.8f), new ExperiencedTalent(2, 1.0f), new ExperiencedTalent(2, 1.2f), new ExperiencedTalent(2, 1.4f), new ExperiencedTalent(2, 1.6f), new ExperiencedTalent(2, 1.8f), new ExperiencedTalent(2, 2.0f));
        this.PARRY = new TalentGroup<ParryTalent>("Parry", new ParryTalent(2, 0.02f), new ParryTalent(2, 0.04f), new ParryTalent(2, 0.06f), new ParryTalent(2, 0.08f), new ParryTalent(2, 0.1f), new ParryTalent(2, 0.12f), new ParryTalent(2, 0.14f), new ParryTalent(2, 0.16f), new ParryTalent(2, 0.18f), new ParryTalent(2, 0.2f));
        ...
        this.CHUNKY = TalentGroup.ofAttribute("Chunky", Attributes.MAX_HEALTH, "Extra Health 2", 10, i -> (i < 5) ? 2 : 3, i -> i * 2.0, i -> AttributeModifier.Operation.ADDITION);
        ...
        this.BREAKABLE = new TalentGroup<BreakableTalent>("Breakable", new BreakableTalent(1, 0.1f, 0.0f), new BreakableTalent(1, 0.15f, -0.2f), new BreakableTalent(1, 0.2f, -0.3f), new BreakableTalent(1, 0.25f, -0.4f));
        this.LUCKY_ALTAR = new TalentGroup<LuckyAltarTalent>("Lucky Altar", new LuckyAltarTalent(3, 0.1f), new LuckyAltarTalent(6, 0.2f), new LuckyAltarTalent(8, 0.25f));
        this.FATAL_STRIKE = new TalentGroup<FatalStrikeTalent>("Fatal Strike", new FatalStrikeTalent(5, 0.05f, 0.5f));
        this.FATAL_STRIKE_CHANCE = new TalentGroup<FatalStrikeChanceTalent>("Fatal Strike Chance", new FatalStrikeChanceTalent(2, 0.05f), new FatalStrikeChanceTalent(2, 0.06f), new FatalStrikeChanceTalent(2, 0.07f), new FatalStrikeChanceTalent(2, 0.08f), new FatalStrikeChanceTalent(2, 0.09f), new FatalStrikeChanceTalent(2, 0.1f), new FatalStrikeChanceTalent(2, 0.11f), new FatalStrikeChanceTalent(2, 0.12f), new FatalStrikeChanceTalent(2, 0.13f), new FatalStrikeChanceTalent(2, 0.15f));
        this.FATAL_STRIKE_DAMAGE = new TalentGroup<FatalStrikeDamageTalent>("Fatal Strike Damage", new FatalStrikeDamageTalent(2, 1.0f), new FatalStrikeDamageTalent(2, 1.1f), new FatalStrikeDamageTalent(2, 1.2f), new FatalStrikeDamageTalent(2, 1.3f), new FatalStrikeDamageTalent(2, 1.4f), new FatalStrikeDamageTalent(2, 1.5f), new FatalStrikeDamageTalent(2, 1.6f), new FatalStrikeDamageTalent(2, 1.7f), new FatalStrikeDamageTalent(2, 1.8f), new FatalStrikeDamageTalent(2, 2.0f));
        this.THORNS = new TalentGroup<ThornsTalent>("Thorns", new ThornsTalent(5, 0.05f, 0.5f));
        this.THORNS_CHANCE = new TalentGroup<ThornsChanceTalent>("Thorns Chance", new ThornsChanceTalent(2, 0.05f), new ThornsChanceTalent(2, 0.06f), new ThornsChanceTalent(2, 0.07f), new ThornsChanceTalent(2, 0.08f), new ThornsChanceTalent(2, 0.09f), new ThornsChanceTalent(2, 0.1f), new ThornsChanceTalent(2, 0.11f), new ThornsChanceTalent(2, 0.12f), new ThornsChanceTalent(2, 0.13f), new ThornsChanceTalent(2, 0.15f));
        this.THORNS_DAMAGE = new TalentGroup<ThornsDamageTalent>("Thorns Damage", new ThornsDamageTalent(2, 1.0f), new ThornsDamageTalent(2, 1.1f), new ThornsDamageTalent(2, 1.2f), new ThornsDamageTalent(2, 1.3f), new ThornsDamageTalent(2, 1.4f), new ThornsDamageTalent(2, 1.5f), new ThornsDamageTalent(2, 1.6f), new ThornsDamageTalent(2, 1.7f), new ThornsDamageTalent(2, 1.8f), new ThornsDamageTalent(2, 2.0f));
        this.GLASS_CANNON = new ArchetypeTalentGroup<GlassCannonTalent>("Glass Cannon", new GlassCannonTalent(2, 1.5f, 1.5f));
        this.COMMANDER = new ArchetypeTalentGroup<CommanderTalent>("Commander", new CommanderTalent(2, 1.2f, 0.8f, 0.1f, 1.5f, true));
        this.WARD = new ArchetypeTalentGroup<WardTalent>("Ward", new WardTalent(2, 15, new EffectTalent(0, Effects.LUCK, 1, EffectTalent.Type.HIDDEN, EffectTalent.Operator.ADD), 0.01f));
        this.BARBARIC = new ArchetypeTalentGroup<BarbaricTalent>("Barbaric", new BarbaricTalent(2, 100, 0.015f, 1));
        this.SOUL_HUNTER = new TalentGroup<SoulShardTalent>("Soul Hunter", new SoulShardTalent(2, 0.25f), new SoulShardTalent(2, 0.5f), new SoulShardTalent(2, 0.75f), new SoulShardTalent(2, 1.0f));
        this.BARRIER = new TalentGroup<AbsorptionTalent>("Barrier", new AbsorptionTalent(1, 0.1f));
    }
}
