...
public class JigsawGeneratorLegacy {
    public static void addPieces(DynamicRegistries p_242837_0_, VillageConfig p_242837_1_, JigsawManager.IPieceFactory p_242837_2_, ChunkGenerator p_242837_3_, TemplateManager p_242837_4_, BlockPos p_242837_5_, List<? super AbstractVillagePiece> p_242837_6_, Random p_242837_7_, boolean p_242837_8_, boolean p_242837_9_) {
        ...
        if (p_242837_1_.maxDepth() > 0) {
            ...
            Assembler jigsawmanager$assembler = new Assembler((Registry) mutableregistry, p_242837_1_.maxDepth(), p_242837_2_, p_242837_3_, p_242837_4_, p_242837_6_, p_242837_7_);
                ...
                if (mainJigsawPattern.isPresent() && (((JigsawPattern) mainJigsawPattern.get()).size() != 0 || Objects.equals(resourcelocation, JigsawPatternRegistry.EMPTY.location()))) {
                    ...
                    if (fallbackJigsawPattern.isPresent() && (((JigsawPattern) fallbackJigsawPattern.get()).size() != 0 || Objects.equals(resourcelocation1, JigsawPatternRegistry.EMPTY.location()))) {
                        ...
                        if (currentDepth != this.maxDepth) {
                            list.addAll(((JigsawPattern) mainJigsawPattern.get()).getShuffledTemplates(this.rand));
                            list.addAll(((JigsawPattern) fallbackJigsawPattern.get()).getShuffledTemplates(this.rand));
                        } else {
                            list.addAll(((JigsawPattern) fallbackJigsawPattern.get()).getShuffledTemplates(this.rand));
                        }
...
/* Location:              C:\Users\Grady\Desktop\the_vault-1.7.2p1.12.4.jar!\iskallia\vault\world\gen\structure\JigsawGeneratorLegacy.class
