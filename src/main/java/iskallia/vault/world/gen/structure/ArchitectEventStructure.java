...
public class ArchitectEventStructure extends Structure<ArchitectEventStructure.Config> {
    public ArchitectEventStructure(Codec<Config> codec) {
        super(codec);
    }
    ...
    public static class Start
        ...
        public void generatePieces(DynamicRegistries registry, ChunkGenerator gen, TemplateManager manager, int chunkX, int chunkZ, Biome biome, ArchitectEventStructure.Config config) {
        ...
        public void generate(JigsawGenerator jigsaw, DynamicRegistries registry, ChunkGenerator gen, TemplateManager manager) {
            ...
            jigsaw.generate(registry, (new VaultStructure.Config(() -> (JigsawPattern) registry.registryOrThrow(Registry.TEMPLATE_POOL_REGISTRY).get(Vault.id("architect_event/starts")), 1))
    ...
    public static class Pools {
        public static final JigsawPattern START = JigsawPatternRegistry.register(new JigsawPattern(
                Vault.id("architect_event/starts"), new ResourceLocation("empty"), (List) ImmutableList.of(
                Pair.of(JigsawPiece.single(Vault.sId("architect_event/starts"), ProcessorLists.EMPTY), Integer.valueOf(1))), JigsawPattern.PlacementBehaviour.RIGID));
...
/* Location:              C:\Users\Grady\Desktop\the_vault-1.7.2p1.12.4.jar!\iskallia\vault\world\gen\structure\ArchitectEventStructure.class
