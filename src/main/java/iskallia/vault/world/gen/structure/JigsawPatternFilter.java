...
//            if (this.isApplicable(weightedPiece.getFirst())) {
//                this.filteredPieceCache.add(weightedPiece.getFirst(), weightedPiece.getSecond());
//            }
//            return;
//        });
...
//        TODO: check if the following overwrite is runnable
        while (true) {
            JigsawPiece piece = pattern.getRandomTemplate(random);
            if (isApplicable(piece))
                return piece;
        }
    }
