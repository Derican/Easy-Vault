...
public class ArchitectEventGenerator extends VaultGenerator {
    public ArchitectEventGenerator(ResourceLocation id) {
        super(id);
    }
    ...
    public boolean generate(ServerWorld world, VaultRaid vault, BlockPos.Mutable pos) {
        ...
        try {
            ...
            StructureStart<?> start = ModFeatures.ARCHITECT_EVENT_FEATURE.generate(jigsaw, world.registryAccess(),
...
/* Location:              C:\Users\Grady\Desktop\the_vault-1.7.2p1.12.4.jar!\iskallia\vault\world\vault\gen\ArchitectEventGenerator.class
