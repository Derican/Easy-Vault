...
public class DamageTakenModifier
    ...
    public ITextComponent getDisplay(float value) {
        ...
        return (ITextComponent) (new StringTextComponent("+" + percDisplay + "% increased Damage taken"))
                .withStyle(TextFormatting.RED);
    }
}


/* Location:              C:\Users\Grady\Desktop\the_vault-1.7.2p1.12.4.jar!\iskallia\vault\world\vault\logic\objective\raid\modifier\DamageTakenModifier.class
