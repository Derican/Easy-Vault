...
public class ModItems {
    ...
    public static void registerItems(final RegistryEvent.Register<Item> event) {
        ...
        registry.register(ModItems.VAULT_BURGER);
        registry.register(ModItems.OOZING_PIZZA);
        registry.register(ModItems.VAULT_COOKIE);
        registry.register(ModItems.SKILL_ORB);
        registry.register(ModItems.ALEXANDRITE_GEM);
        registry.register(ModItems.BENITOITE_GEM);
        registry.register(ModItems.LARIMAR_GEM);
        registry.register(ModItems.BLACK_OPAL_GEM);
        registry.register(ModItems.PAINITE_GEM);
        registry.register(ModItems.ISKALLIUM_GEM);
        registry.register(ModItems.GORGINITE_GEM);
        registry.register(ModItems.SPARKLETINE_GEM);
        registry.register(ModItems.ASHIUM_GEM);
        registry.register(ModItems.BOMIGNITE_GEM);
        registry.register(ModItems.FUNSOIDE_GEM);
        registry.register(ModItems.TUBIUM_GEM);
        registry.register(ModItems.WUTODIE_GEM);
        registry.register(ModItems.UPALINE_GEM);
        registry.register(ModItems.PUFFIUM_GEM);
        registry.register(ModItems.ECHO_GEM);
        registry.register(ModItems.VAULT_ROCK);
        registry.register(ModItems.POG);
        registry.register(ModItems.ECHO_POG);
        registry.register(ModItems.VAULT_CRYSTAL);
        registry.register(ModItems.ISKALLIUM_KEY);
        registry.register(ModItems.GORGINITE_KEY);
        registry.register(ModItems.SPARKLETINE_KEY);
        registry.register(ModItems.ASHIUM_KEY);
        registry.register(ModItems.BOMIGNITE_KEY);
        registry.register(ModItems.FUNSOIDE_KEY);
        registry.register(ModItems.TUBIUM_KEY);
        registry.register(ModItems.UPALINE_KEY);
        registry.register(ModItems.PUFFIUM_KEY);
        registry.register(ModItems.RELIC_BOOSTER_PACK);
        registry.register(ModItems.DRAGON_HEAD_RELIC);
        registry.register(ModItems.DRAGON_TAIL_RELIC);
        registry.register(ModItems.DRAGON_FOOT_RELIC);
        registry.register(ModItems.DRAGON_CHEST_RELIC);
        registry.register(ModItems.DRAGON_BREATH_RELIC);
        registry.register(ModItems.MINERS_DELIGHT_RELIC);
        registry.register(ModItems.MINERS_LIGHT_RELIC);
        registry.register(ModItems.PICKAXE_HANDLE_RELIC);
        registry.register(ModItems.PICKAXE_HEAD_RELIC);
        registry.register(ModItems.PICKAXE_TOOL_RELIC);
        registry.register(ModItems.SWORD_BLADE_RELIC);
        registry.register(ModItems.SWORD_HANDLE_RELIC);
        registry.register(ModItems.SWORD_STICK_RELIC);
        registry.register(ModItems.WARRIORS_ARMOUR_RELIC);
        registry.register(ModItems.WARRIORS_CHARM_RELIC);
        registry.register(ModItems.DIAMOND_ESSENCE_RELIC);
        registry.register(ModItems.GOLD_ESSENCE_RELIC);
        registry.register(ModItems.MYSTIC_GEM_ESSENCE_RELIC);
        registry.register(ModItems.NETHERITE_ESSENCE_RELIC);
        registry.register(ModItems.PLATINUM_ESSENCE_RELIC);
        registry.register(ModItems.CUPCAKE_BLUE_RELIC);
        registry.register(ModItems.CUPCAKE_LIME_RELIC);
        registry.register(ModItems.CUPCAKE_PINK_RELIC);
        registry.register(ModItems.CUPCAKE_PURPLE_RELIC);
        registry.register(ModItems.CUPCAKE_RED_RELIC);
        registry.register(ModItems.AIR_RELIC);
        registry.register(ModItems.SPIRIT_RELIC);
        registry.register(ModItems.FIRE_RELIC);
        registry.register(ModItems.EARTH_RELIC);
        registry.register(ModItems.WATER_RELIC);
        registry.register(ModItems.TWOLF999_HEAD_RELIC);
        registry.register(ModItems.TWOLF999_COMBAT_VEST_RELIC);
        registry.register(ModItems.TWOLF999_COMBAT_LEGGINGS_RELIC);
        registry.register(ModItems.TWOLF999_COMBAT_GLOVES_RELIC);
        registry.register(ModItems.TWOLF999_COMBAT_BOOTS_RELIC);
        registry.register(ModItems.ARMOR_OF_FORBEARANCE_RELIC);
        registry.register(ModItems.HEART_OF_THE_VOID_RELIC);
        registry.register(ModItems.NEMESIS_THWARTER_RELIC);
        registry.register(ModItems.REVERENCE_EDGE_RELIC);
        registry.register(ModItems.WINGS_OF_EQUITY_RELIC);
        registry.register(ModItems.TWITCH_EMOTE1_RELIC);
        registry.register(ModItems.TWITCH_EMOTE2_RELIC);
        registry.register(ModItems.TWITCH_EMOTE3_RELIC);
        registry.register(ModItems.TWITCH_EMOTE4_RELIC);
        registry.register(ModItems.TWITCH_EMOTE5_RELIC);
        registry.register(ModItems.VAULT_RUNE);
        registry.register(ModItems.TRADER_CORE);
        registry.register(ModItems.LEGENDARY_TREASURE_NORMAL);
        registry.register(ModItems.LEGENDARY_TREASURE_RARE);
        registry.register(ModItems.LEGENDARY_TREASURE_EPIC);
        registry.register(ModItems.LEGENDARY_TREASURE_OMEGA);
        registry.register(ModItems.UNIDENTIFIED_ARTIFACT);
        registry.register(ModItems.VAULT_RELIC);
        registry.register(ModItems.SKILL_ORB_FRAME);
        registry.register(ModItems.SKILL_SHARD);
        registry.register(ModItems.BITTER_LEMON);
        registry.register(ModItems.SOUR_ORANGE);
        registry.register(ModItems.MYSTIC_PEAR);
        registry.register(ModItems.KEY_PIECE);
        registry.register(ModItems.KEY_MOULD);
        registry.register(ModItems.BLANK_KEY);
        registry.register(ModItems.NETHERITE_CLUSTER);
        registry.register(ModItems.ISKALLIUM_CLUSTER);
        registry.register(ModItems.GORGINITE_CLUSTER);
        registry.register(ModItems.SPARKLETINE_CLUSTER);
        registry.register(ModItems.ASHIUM_CLUSTER);
        registry.register(ModItems.BOMIGNITE_CLUSTER);
        registry.register(ModItems.FUNSOIDE_CLUSTER);
        registry.register(ModItems.TUBIUM_CLUSTER);
        registry.register(ModItems.UPALINE_CLUSTER);
        registry.register(ModItems.PUFFIUM_CLUSTER);
        registry.register(ModItems.VAULT_STEW_MYSTERY);
        registry.register(ModItems.VAULT_STEW_NORMAL);
        registry.register(ModItems.VAULT_STEW_RARE);
        registry.register(ModItems.VAULT_STEW_EPIC);
        registry.register(ModItems.VAULT_STEW_OMEGA);
        registry.register(ModItems.POISONOUS_MUSHROOM);
        registry.register(ModItems.VAULT_GOLD);
        registry.register(ModItems.VAULT_DIAMOND);
        registry.register(ModItems.SKILL_ESSENCE);
        registry.register(ModItems.UNIDENTIFIED_RELIC);
        registry.register(ModItems.SWEET_KIWI);
        registry.register(ModItems.HUNTER_EYE);
        registry.register(ModItems.BURGER_PATTY);
        registry.register(ModItems.BURGER_BUN);
        registry.register(ModItems.MATURE_CHEDDAR);
        registry.register(ModItems.MYSTIC_TOMATO);
        registry.register(ModItems.VAULT_SCRAP);
        registry.register(ModItems.VAULT_INGOT);
        registry.register(ModItems.VAULT_PLATINUM);
        registry.register(ModItems.MYSTERY_BOX);
        registry.register(ModItems.DRILL_ARROW_PART);
        registry.register(ModItems.DRILL_ARROW);
        registry.register(ModItems.RESPEC_FLASK);
        registry.register(ModItems.RESET_FLASK);
        registry.register(ModItems.MYSTERY_EGG);
        registry.register(ModItems.MYSTERY_HOSTILE_EGG);
        registry.register(ModItems.ACCELERATION_CHIP);
        registry.register(ModItems.PANDORAS_BOX);
        registry.register(ModItems.ISKALLIUM_CHUNK);
        registry.register(ModItems.GORGINITE_CHUNK);
        registry.register(ModItems.SPARKLETINE_CHUNK);
        registry.register(ModItems.ASHIUM_CHUNK);
        registry.register(ModItems.BOMIGNITE_CHUNK);
        registry.register(ModItems.FUNSOIDE_CHUNK);
        registry.register(ModItems.TUBIUM_CHUNK);
        registry.register(ModItems.UPALINE_CHUNK);
        registry.register(ModItems.PUFFIUM_CHUNK);
        registry.register(ModItems.OMEGA_POG);
        registry.register(ModItems.ETERNAL_SOUL);
        registry.register(ModItems.SPARK);
        registry.register(ModItems.STAR_SHARD);
        registry.register(ModItems.STAR_CORE);
        registry.register(ModItems.STAR_ESSENCE);
        registry.register(ModItems.KNOWLEDGE_STAR);
        registry.register(ModItems.SWORD);
        registry.register(ModItems.AXE);
        registry.register(ModItems.HELMET);
        registry.register(ModItems.CHESTPLATE);
        registry.register(ModItems.LEGGINGS);
        registry.register(ModItems.BOOTS);
        registry.register(ModItems.ETCHING);
        registry.register(ModItems.ETCHING_FRAGMENT);
        registry.register(ModItems.IDOL_BENEVOLENT);
        registry.register(ModItems.IDOL_OMNISCIENT);
        registry.register(ModItems.IDOL_TIMEKEEPER);
        registry.register(ModItems.IDOL_MALEVOLENCE);
        registry.register(ModItems.PUZZLE_RUNE);
        registry.register(ModItems.INFUSED_ETERNAL_SOUL);
        registry.register(ModItems.UNKNOWN_EGG);
        registry.register(ModItems.CANDY_BAR);
        registry.register(ModItems.POWER_BAR);
        registry.register(ModItems.JADE_APPLE);
        registry.register(ModItems.COBALT_APPLE);
        registry.register(ModItems.PIXIE_APPLE);
        registry.register(ModItems.VAULT_APPLE);
        registry.register(ModItems.LUCKY_APPLE);
        registry.register(ModItems.TREASURE_APPLE);
        registry.register(ModItems.POWER_APPLE);
        registry.register(ModItems.GHOST_APPLE);
        registry.register(ModItems.GOLEM_APPLE);
        registry.register(ModItems.SWEET_APPLE);
        registry.register(ModItems.HEARTY_APPLE);
        registry.register(ModItems.PERFECT_ALEXANDRITE);
        registry.register(ModItems.PERFECT_PAINITE);
        registry.register(ModItems.PERFECT_BENITOITE);
        registry.register(ModItems.PERFECT_LARIMAR);
        registry.register(ModItems.PERFECT_BLACK_OPAL);
        registry.register(ModItems.PERFECT_ECHO_GEM);
        registry.register(ModItems.PERFECT_WUTODIE);
        registry.register(ModItems.VAULT_DUST);
        registry.register(ModItems.VAULT_NUGGET);
        registry.register(ModItems.VAULT_BRONZE);
        registry.register(ModItems.VAULT_SILVER);
        registry.register(ModItems.MAGNETITE);
        registry.register(ModItems.MAGNET_CORE_WEAK);
        registry.register(ModItems.MAGNET_CORE_STRONG);
        registry.register(ModItems.MAGNET_CORE_OMEGA);
        registry.register(ModItems.VAULT_ESSENCE);
        registry.register(ModItems.REPAIR_CORE);
        registry.register(ModItems.REPAIR_CORE_T2);
        registry.register(ModItems.REPAIR_CORE_T3);
        registry.register(ModItems.VAULT_PLATING);
        registry.register(ModItems.VAULT_PLATING_T2);
        registry.register(ModItems.VAULT_PLATING_T3);
        registry.register(ModItems.WUTAX_SHARD);
        registry.register(ModItems.WUTAX_CRYSTAL);
        registry.register(ModItems.VAULT_CATALYST);
        registry.register(ModItems.VAULT_INHIBITOR);
        registry.register(ModItems.PAINITE_STAR);
        registry.register(ModItems.VAULT_RUNE_MINE);
        registry.register(ModItems.VAULT_RUNE_PUZZLE);
        registry.register(ModItems.VAULT_RUNE_DIGSITE);
        registry.register(ModItems.VAULT_RUNE_CRYSTAL);
        registry.register(ModItems.VAULT_RUNE_VIEWER);
        registry.register(ModItems.VAULT_RUNE_VENDOR);
        registry.register(ModItems.VAULT_RUNE_XMARK);
        registry.register(ModItems.VAULT_CATALYST_FRAGMENT);
        registry.register(ModItems.VAULT_SAND);
        registry.register(ModItems.SOUL_FLAME);
        registry.register(ModItems.VAULT_GEAR);
        registry.register(ModItems.CRYSTAL_SEAL_EXECUTIONER);
        registry.register(ModItems.CRYSTAL_SEAL_HUNTER);
        registry.register(ModItems.CRYSTAL_SEAL_ARCHITECT);
        registry.register(ModItems.CRYSTAL_SEAL_ANCIENTS);
        registry.register(ModItems.CRYSTAL_SEAL_RAID);
        registry.register(ModItems.CRYSTAL_SEAL_RAFFLE);
        registry.register(ModItems.GEAR_CHARM);
        registry.register(ModItems.GEAR_CHARM_T3);
        registry.register(ModItems.IDENTIFICATION_TOME);
        registry.register(ModItems.BANISHED_SOUL);
        registry.register(ModItems.UNKNOWN_ITEM);
        registry.register(ModItems.SOUL_SHARD);
        registry.register(ModItems.SHARD_POUCH);
        registry.register(ModItems.PAXEL_CHARM);
        registry.register(ModItems.VAULT_PAXEL);
        registry.register(ModItems.INFINITE_WATER_BUCKET);
        registry.register(ModItems.VAULT_PEARL);
        registry.register(ModItems.VAULT_MAGNET_WEAK);
        registry.register(ModItems.VAULT_MAGNET_STRONG);
        registry.register(ModItems.VAULT_MAGNET_OMEGA);
        registry.register(ModItems.SCAVENGER_CREEPER_EYE);
        registry.register(ModItems.SCAVENGER_CREEPER_FOOT);
        registry.register(ModItems.SCAVENGER_CREEPER_FUSE);
        registry.register(ModItems.SCAVENGER_CREEPER_TNT);
        registry.register(ModItems.SCAVENGER_CREEPER_VIAL);
        registry.register(ModItems.SCAVENGER_CREEPER_CHARM);
        registry.register(ModItems.SCAVENGER_DROWNED_BARNACLE);
        registry.register(ModItems.SCAVENGER_DROWNED_EYE);
        registry.register(ModItems.SCAVENGER_DROWNED_HIDE);
        registry.register(ModItems.SCAVENGER_DROWNED_VIAL);
        registry.register(ModItems.SCAVENGER_DROWNED_CHARM);
        registry.register(ModItems.SCAVENGER_SKELETON_SHARD);
        registry.register(ModItems.SCAVENGER_SKELETON_EYE);
        registry.register(ModItems.SCAVENGER_SKELETON_RIBCAGE);
        registry.register(ModItems.SCAVENGER_SKELETON_SKULL);
        registry.register(ModItems.SCAVENGER_SKELETON_WISHBONE);
        registry.register(ModItems.SCAVENGER_SKELETON_VIAL);
        registry.register(ModItems.SCAVENGER_SKELETON_CHARM);
        registry.register(ModItems.SCAVENGER_SPIDER_FANGS);
        registry.register(ModItems.SCAVENGER_SPIDER_LEG);
        registry.register(ModItems.SCAVENGER_SPIDER_WEBBING);
        registry.register(ModItems.SCAVENGER_SPIDER_CURSED_CHARM);
        registry.register(ModItems.SCAVENGER_SPIDER_VIAL);
        registry.register(ModItems.SCAVENGER_SPIDER_CHARM);
        registry.register(ModItems.SCAVENGER_ZOMBIE_BRAIN);
        registry.register(ModItems.SCAVENGER_ZOMBIE_ARM);
        registry.register(ModItems.SCAVENGER_ZOMBIE_EAR);
        registry.register(ModItems.SCAVENGER_ZOMBIE_EYE);
        registry.register(ModItems.SCAVENGER_ZOMBIE_HIDE);
        registry.register(ModItems.SCAVENGER_ZOMBIE_NOSE);
        registry.register(ModItems.SCAVENGER_ZOMBIE_VIAL);
        registry.register(ModItems.SCAVENGER_TREASURE_BANGLE_BLUE);
        registry.register(ModItems.SCAVENGER_TREASURE_BANGLE_PINK);
        registry.register(ModItems.SCAVENGER_TREASURE_BANGLE_GREEN);
        registry.register(ModItems.SCAVENGER_TREASURE_EARRINGS);
        registry.register(ModItems.SCAVENGER_TREASURE_GOBLET);
        registry.register(ModItems.SCAVENGER_TREASURE_SACK);
        registry.register(ModItems.SCAVENGER_TREASURE_SCROLL_RED);
        registry.register(ModItems.SCAVENGER_TREASURE_SCROLL_BLUE);
        registry.register(ModItems.SCAVENGER_SCRAP_BROKEN_POTTERY);
        registry.register(ModItems.SCAVENGER_SCRAP_CRACKED_PEARL);
        registry.register(ModItems.SCAVENGER_SCRAP_CRACKED_SCRIPT);
        registry.register(ModItems.SCAVENGER_SCRAP_EMPTY_JAR);
        registry.register(ModItems.SCAVENGER_SCRAP_OLD_BOOK);
        registry.register(ModItems.SCAVENGER_SCRAP_POTTERY_SHARD);
        registry.register(ModItems.SCAVENGER_SCRAP_POULTICE_JAR);
        registry.register(ModItems.SCAVENGER_SCRAP_PRESERVES_JAR);
        registry.register(ModItems.SCAVENGER_SCRAP_RIPPED_PAGE);
        registry.register(ModItems.SCAVENGER_SCRAP_SADDLE_BAG);
        ...
        registry.register(ModItems.TENOS_ESSENCE);
        registry.register(ModItems.VELARA_ESSENCE);
        registry.register(ModItems.WENDARR_ESSENCE);
        registry.register(ModItems.IDONA_ESSENCE);
        ...
        registry.register(ModItems.VOID_ORB);
        registry.register(ModItems.CRYSTAL_BURGER);
        registry.register(ModItems.FULL_PIZZA);
        registry.register(ModItems.LIFE_SCROLL);
        registry.register(ModItems.AURA_SCROLL);
        registry.register(ModItems.ARTISAN_SCROLL);
        registry.register(ModItems.FABRICATION_JEWEL);
        registry.register(ModItems.FLAWED_RUBY);
        registry.register(ModItems.ARMOR_CRATE_HELLCOW);
        registry.register(ModItems.ARMOR_CRATE_BOTANIA);
        registry.register(ModItems.ARMOR_CRATE_CREATE);
        registry.register(ModItems.ARMOR_CRATE_DANK);
        registry.register(ModItems.ARMOR_CRATE_FLUX);
        registry.register(ModItems.ARMOR_CRATE_IMMERSIVE_ENGINEERING);
        registry.register(ModItems.ARMOR_CRATE_MEKA);
        registry.register(ModItems.ARMOR_CRATE_POWAH);
        registry.register(ModItems.ARMOR_CRATE_THERMAL);
        registry.register(ModItems.ARMOR_CRATE_TRASH);
        registry.register(ModItems.ARMOR_CRATE_VILLAGER);
        registry.register(ModItems.ARMOR_CRATE_AUTOMATIC);
        registry.register(ModItems.ARMOR_CRATE_FAIRY);
        registry.register(ModItems.ARMOR_CRATE_BUILDING);
        registry.register(ModItems.ARMOR_CRATE_ZOMBIE);
        registry.register(ModItems.ARMOR_CRATE_XNET);
        registry.register(ModItems.ARMOR_CRATE_TEST_DUMMY);
        registry.register(ModItems.ARMOR_CRATE_INDUSTRIAL_FOREGOING);
        registry.register(ModItems.ARMOR_CRATE_CAKE);
        registry.register(ModItems.ARTIFACT_FRAGMENT);
        registry.register(ModItems.VAULT_CHARM);
        registry.register(ModItems.CHARM_UPGRADE_TIER_1);
        registry.register(ModItems.CHARM_UPGRADE_TIER_2);
        registry.register(ModItems.CHARM_UPGRADE_TIER_3);
        registry.register(ModItems.CHARM_UPGRADE_TIER_4);
    }
    ...
    static {
        ...
        ModItems.UNIDENTIFIED_RELIC = new LootableItem(Vault.id("unidentified_relic"), new Item.Properties().tab(ModItems.VAULT_MOD_GROUP), () -> new ItemStack(ModConfigs.VAULT_RELICS.getRandomPart()));
        ...
        ModItems.VAULT_SCRAP = new BasicTooltipItem(Vault.id("vault_scrap"), new Item.Properties().tab(ModItems.VAULT_MOD_GROUP), new StringTextComponent("The scrap of smelted down vault gear.").withStyle(TextFormatting.GRAY), new StringTextComponent("Can be used to craft a repair core.").withStyle(TextFormatting.GRAY));
        ...
        ModItems.ACCELERATION_CHIP = new BasicTooltipItem(Vault.id("acceleration_chip"), new Item.Properties().tab(ModItems.VAULT_MOD_GROUP), new StringTextComponent("Right click to install in an omega statue to accelerate").withStyle(TextFormatting.GRAY), new StringTextComponent("the speed of production, each chip lowers the wait time by 5 seconds").withStyle(TextFormatting.GRAY));
        ...
        ModItems.MAGNETITE = new BasicTooltipItem(Vault.id("magnetite"), new Item.Properties().tab(ModItems.VAULT_MOD_GROUP), new StringTextComponent("Can be used to repair vault magnets,").withStyle(TextFormatting.GRAY), new StringTextComponent("or craft new ones.").withStyle(TextFormatting.GRAY));
        ...
        ModItems.VAULT_ESSENCE = new BasicTooltipItem(Vault.id("vault_essence"), new Item.Properties().tab(ModItems.VAULT_MOD_GROUP), new StringTextComponent("A rare essence of the vaults.").withStyle(TextFormatting.GRAY), new StringTextComponent("Used as an ingredient in several crafting recipes, including regeneration potions.").withStyle(TextFormatting.GRAY));
        ModItems.REPAIR_CORE = new VaultRepairCoreItem(Vault.id("repair_core"), new Item.Properties().tab(ModItems.VAULT_MOD_GROUP), 0, new StringTextComponent("Can be used to fully repair any vault gear,").withStyle(TextFormatting.GRAY), new StringTextComponent("as long as it has repair slots remaining.").withStyle(TextFormatting.GRAY));
        ModItems.REPAIR_CORE_T2 = new VaultRepairCoreItem(Vault.id("repair_core_t2"), new Item.Properties().tab(ModItems.VAULT_MOD_GROUP), 1, new StringTextComponent("Can be used to fully repair any vault gear,").withStyle(TextFormatting.GRAY), new StringTextComponent("as long as it has repair slots remaining.").withStyle(TextFormatting.GRAY));
        ModItems.REPAIR_CORE_T3 = new VaultRepairCoreItem(Vault.id("repair_core_t3"), new Item.Properties().tab(ModItems.VAULT_MOD_GROUP), 2, new StringTextComponent("Can be used to fully repair any vault gear,").withStyle(TextFormatting.GRAY), new StringTextComponent("as long as it has repair slots remaining.").withStyle(TextFormatting.GRAY));
        ModItems.VAULT_PLATING = new VaultPlateItem(Vault.id("vault_plating"), new Item.Properties().tab(ModItems.VAULT_MOD_GROUP), 0, new StringTextComponent("Permanently adds 50 max durability to any vault gear.").withStyle(TextFormatting.GRAY), new StringTextComponent("Maximum 20 plates can be attached to any one vault gear.").withStyle(TextFormatting.GRAY));
        ModItems.VAULT_PLATING_T2 = new VaultPlateItem(Vault.id("vault_plating_t2"), new Item.Properties().tab(ModItems.VAULT_MOD_GROUP), 1, new StringTextComponent("Permanently adds 50 max durability to any vault gear.").withStyle(TextFormatting.GRAY), new StringTextComponent("Maximum 20 plates can be attached to any one vault gear.").withStyle(TextFormatting.GRAY));
        ModItems.VAULT_PLATING_T3 = new VaultPlateItem(Vault.id("vault_plating_t3"), new Item.Properties().tab(ModItems.VAULT_MOD_GROUP), 2, new StringTextComponent("Permanently adds 50 max durability to any vault gear.").withStyle(TextFormatting.GRAY), new StringTextComponent("Maximum 20 plates can be attached to any one vault gear.").withStyle(TextFormatting.GRAY));
        ...
        ModItems.PAINITE_STAR = new BasicTooltipItem(Vault.id("painite_star"), new Item.Properties().tab(ModItems.VAULT_MOD_GROUP).stacksTo(4), new StringTextComponent("Reroll the vault catalyst combination results").withStyle(TextFormatting.GRAY));
        ...
        ModItems.VAULT_CATALYST_FRAGMENT = new BasicTooltipItem(Vault.id("vault_catalyst_fragment"), new Item.Properties().tab(ModItems.VAULT_MOD_GROUP), new StringTextComponent("Can be used to craft very powerful Catalysts,").withStyle(TextFormatting.GRAY), new StringTextComponent("which can modify a vault crystal.").withStyle(TextFormatting.GRAY));
        ...
        ModItems.GEAR_CHARM = new BasicTooltipItem(Vault.id("gear_charm"), new Item.Properties().tab(ModItems.VAULT_MOD_GROUP), new StringTextComponent("Combine with an unidentified vault gear in an anvil").withStyle(TextFormatting.GRAY), new StringTextComponent("to increase its tier to Tier 2.").withStyle(TextFormatting.GRAY), new StringTextComponent("Requires level: ").withStyle(TextFormatting.GRAY).append(new StringTextComponent("100").withStyle(TextFormatting.AQUA)));
        ModItems.GEAR_CHARM_T3 = new BasicTooltipItem(Vault.id("gear_charm_tier_3"), new Item.Properties().tab(ModItems.VAULT_MOD_GROUP), new StringTextComponent("Combine with an unidentified vault gear in an anvil").withStyle(TextFormatting.GRAY), new StringTextComponent("to increase its tier to Tier 3.").withStyle(TextFormatting.GRAY), new StringTextComponent("Requires level: ").withStyle(TextFormatting.GRAY).append(new StringTextComponent("200").withStyle(TextFormatting.AQUA)));
        ModItems.IDENTIFICATION_TOME = new BasicTooltipItem(Vault.id("identification_tome"), new Item.Properties().tab(ModItems.VAULT_MOD_GROUP).stacksTo(1), new StringTextComponent("Hold in the off hand to instantly").withStyle(TextFormatting.GRAY), new StringTextComponent("identify vault gear.").withStyle(TextFormatting.GRAY));
        ModItems.BANISHED_SOUL = new BasicTooltipItem(Vault.id("banished_soul"), new Item.Properties().tab(ModItems.VAULT_MOD_GROUP).stacksTo(1), new StringTextComponent("Adds 3000 Durability to a Vault idol.").withStyle(TextFormatting.GRAY), new StringTextComponent("Has a 1 in 3 chance to break the idol when applying.").withStyle(TextFormatting.GRAY));
        ...
        ModItems.PAXEL_CHARM = new BasicTooltipItem(Vault.id("paxel_charm"), new Item.Properties().tab(ModItems.VAULT_MOD_GROUP).stacksTo(1), new StringTextComponent("Combine with a paxel in anvil to enhance it.").withStyle(TextFormatting.AQUA), new StringTextComponent("A paxel can have only one enhancement.").withStyle(TextFormatting.GRAY));
        ...
        VOID_LIQUID_BUCKET = (BucketItem) new BucketItem(ModFluids.VOID_LIQUID, new Item.Properties().craftRemainder(Items.BUCKET).stacksTo(1).tab(ModItems.VAULT_MOD_GROUP)).setRegistryName(Vault.id("void_liquid_bucket"));
        TENOS_ESSENCE = (GodEssenceItem) new GodEssenceItem(Vault.id("god_essence_tenos"), PlayerFavourData.VaultGodType.OMNISCIENT, new Item.Properties().tab(ModItems.VAULT_MOD_GROUP).stacksTo(1)).withTooltip(new StringTextComponent("The eyes are the first to aquire new knowledge when experiencing").withStyle(TextFormatting.ITALIC));
        VELARA_ESSENCE = (GodEssenceItem) new GodEssenceItem(Vault.id("god_essence_velara"), PlayerFavourData.VaultGodType.BENEVOLENT, new Item.Properties().tab(ModItems.VAULT_MOD_GROUP).stacksTo(1)).withTooltip(new StringTextComponent("Life might start blind, but is always seen by the eyes of others").withStyle(TextFormatting.ITALIC));
        WENDARR_ESSENCE = (GodEssenceItem) new GodEssenceItem(Vault.id("god_essence_wendarr"), PlayerFavourData.VaultGodType.TIMEKEEPER, new Item.Properties().tab(ModItems.VAULT_MOD_GROUP).stacksTo(1)).withTooltip(new StringTextComponent("Time can only be perceived by the eyes of a god").withStyle(TextFormatting.ITALIC));
        IDONA_ESSENCE = (GodEssenceItem) new GodEssenceItem(Vault.id("god_essence_idona"), PlayerFavourData.VaultGodType.MALEVOLENCE, new Item.Properties().tab(ModItems.VAULT_MOD_GROUP).stacksTo(1)).withTooltip(new StringTextComponent("Sacrifices are something that please the eyes of the gods").withStyle(TextFormatting.ITALIC));
        ...
        ModItems.CRYSTAL_BURGER = new BasicTooltipItem(Vault.id("crystal_burger"), new Item.Properties().tab(ModItems.VAULT_MOD_GROUP), new StringTextComponent("Eternal Exp food").withStyle(TextFormatting.GOLD));
        ModItems.FULL_PIZZA = new BasicTooltipItem(Vault.id("full_pizza"), new Item.Properties().tab(ModItems.VAULT_MOD_GROUP), new StringTextComponent("Eternal Exp food").withStyle(TextFormatting.GOLD));
        ModItems.LIFE_SCROLL = new BasicTooltipItem(Vault.id("life_scroll"), new Item.Properties().tab(ModItems.VAULT_MOD_GROUP), new StringTextComponent("Revives a unalived eternal").withStyle(TextFormatting.GRAY));
        ModItems.AURA_SCROLL = new BasicTooltipItem(Vault.id("aura_scroll"), new Item.Properties().tab(ModItems.VAULT_MOD_GROUP), new StringTextComponent("Rerolls an eternal's available auras").withStyle(TextFormatting.GRAY));
        ...
        ModItems.FABRICATION_JEWEL = new BasicTooltipItem(Vault.id("fabrication_jewel"), new Item.Properties().tab(ModItems.VAULT_MOD_GROUP), new StringTextComponent("Requires Talent: ").withStyle(TextFormatting.GRAY).append(new StringTextComponent("Artisan").withStyle(TextFormatting.AQUA)));
        ModItems.ARMOR_CRATE_HELLCOW = new ItemModArmorCrate(Vault.id("armor_crate_hellcow"), new Item.Properties().tab(ModItems.VAULT_MOD_GROUP).stacksTo(64), () -> ImmutableList.of(ModModels.SpecialGearModel.HELLCOW_SET));
        ModItems.ARMOR_CRATE_BOTANIA = new ItemModArmorCrate(Vault.id("armor_crate_botania"), new Item.Properties().tab(ModItems.VAULT_MOD_GROUP).stacksTo(64), () -> ImmutableList.of(ModModels.SpecialGearModel.BOTANIA_SET));
        ModItems.ARMOR_CRATE_CREATE = new ItemModArmorCrate(Vault.id("armor_crate_create"), new Item.Properties().tab(ModItems.VAULT_MOD_GROUP).stacksTo(64), () -> ImmutableList.of(ModModels.SpecialGearModel.CREATE_SET));
        ModItems.ARMOR_CRATE_DANK = new ItemModArmorCrate(Vault.id("armor_crate_dank"), new Item.Properties().tab(ModItems.VAULT_MOD_GROUP).stacksTo(64), () -> ImmutableList.of(ModModels.SpecialGearModel.DANK_SET));
        ModItems.ARMOR_CRATE_FLUX = new ItemModArmorCrate(Vault.id("armor_crate_flux"), new Item.Properties().tab(ModItems.VAULT_MOD_GROUP).stacksTo(64), () -> ImmutableList.of(ModModels.SpecialGearModel.FLUX_SET));
        ModItems.ARMOR_CRATE_IMMERSIVE_ENGINEERING = new ItemModArmorCrate(Vault.id("armor_crate_ie"), new Item.Properties().tab(ModItems.VAULT_MOD_GROUP).stacksTo(64), () -> ImmutableList.of(ModModels.SpecialGearModel.IMMERSIVE_ENGINEERING_SET));
        ModItems.ARMOR_CRATE_MEKA = new ItemModArmorCrate(Vault.id("armor_crate_meka"), new Item.Properties().tab(ModItems.VAULT_MOD_GROUP).stacksTo(64), () -> ImmutableList.of(ModModels.SpecialGearModel.MEKA_SET_DARK, ModModels.SpecialGearModel.MEKA_SET_LIGHT));
        ModItems.ARMOR_CRATE_POWAH = new ItemModArmorCrate(Vault.id("armor_crate_powah"), new Item.Properties().tab(ModItems.VAULT_MOD_GROUP).stacksTo(64), () -> ImmutableList.of(ModModels.SpecialGearModel.POWAH_SET));
        ModItems.ARMOR_CRATE_THERMAL = new ItemModArmorCrate(Vault.id("armor_crate_thermal"), new Item.Properties().tab(ModItems.VAULT_MOD_GROUP).stacksTo(64), () -> ImmutableList.of(ModModels.SpecialGearModel.THERMAL_SET));
        ModItems.ARMOR_CRATE_TRASH = new ItemModArmorCrate(Vault.id("armor_crate_trash"), new Item.Properties().tab(ModItems.VAULT_MOD_GROUP).stacksTo(64), () -> ImmutableList.of(ModModels.SpecialGearModel.TRASH_SET));
        ModItems.ARMOR_CRATE_VILLAGER = new ItemModArmorCrate(Vault.id("armor_crate_villager"), new Item.Properties().tab(ModItems.VAULT_MOD_GROUP).stacksTo(64), () -> ImmutableList.of(ModModels.SpecialGearModel.VILLAGER_SET));
        ModItems.ARMOR_CRATE_AUTOMATIC = new ItemModArmorCrate(Vault.id("armor_crate_automatic"), new Item.Properties().tab(ModItems.VAULT_MOD_GROUP).stacksTo(64), () -> ImmutableList.of(ModModels.SpecialGearModel.AUTOMATIC_SET));
        ModItems.ARMOR_CRATE_FAIRY = new ItemModArmorCrate(Vault.id("armor_crate_fairy"), new Item.Properties().tab(ModItems.VAULT_MOD_GROUP).stacksTo(64), () -> ImmutableList.of(ModModels.SpecialGearModel.FAIRY_SET));
        ModItems.ARMOR_CRATE_BUILDING = new ItemModArmorCrate(Vault.id("armor_crate_building"), new Item.Properties().tab(ModItems.VAULT_MOD_GROUP).stacksTo(64), () -> ImmutableList.of(ModModels.SpecialGearModel.BUILDING_SET));
        ModItems.ARMOR_CRATE_ZOMBIE = new ItemModArmorCrate(Vault.id("armor_crate_zombie"), new Item.Properties().tab(ModItems.VAULT_MOD_GROUP).stacksTo(64), () -> ImmutableList.of(ModModels.SpecialGearModel.ZOMBIE_SET));
        ModItems.ARMOR_CRATE_XNET = new ItemModArmorCrate(Vault.id("armor_crate_xnet"), new Item.Properties().tab(ModItems.VAULT_MOD_GROUP).stacksTo(64), () -> ImmutableList.of(ModModels.SpecialGearModel.XNET_SET));
        ModItems.ARMOR_CRATE_TEST_DUMMY = new ItemModArmorCrate(Vault.id("armor_crate_test_dummy"), new Item.Properties().tab(ModItems.VAULT_MOD_GROUP).stacksTo(64), () -> ImmutableList.of(ModModels.SpecialGearModel.TEST_DUMMY_SET));
        ModItems.ARMOR_CRATE_INDUSTRIAL_FOREGOING = new ItemModArmorCrate(Vault.id("armor_crate_if"), new Item.Properties().tab(ModItems.VAULT_MOD_GROUP).stacksTo(64), () -> ImmutableList.of(ModModels.SpecialGearModel.INDUSTRIAL_FOREGOING_SET));
        ModItems.ARMOR_CRATE_CAKE = new ItemModArmorCrate(Vault.id("armor_crate_cake"), new Item.Properties().tab(ModItems.VAULT_MOD_GROUP).stacksTo(64), () -> ImmutableList.of(ModModels.SpecialGearModel.CAKE_SET));
        ModItems.FLAWED_RUBY = new FlawedRubyItem(Vault.id("flawed_ruby"), new Item.Properties().tab(ModItems.VAULT_MOD_GROUP), new StringTextComponent("Combine with a gear piece in an anvil").withStyle(TextFormatting.GRAY), new StringTextComponent("to add additional modifier(s) with a").withStyle(TextFormatting.GRAY), new StringTextComponent("chance that the gear will break.").withStyle(TextFormatting.GRAY), new StringTextComponent(" ").withStyle(TextFormatting.GRAY), new StringTextComponent("Requires Talent: ").withStyle(TextFormatting.GRAY).append(new StringTextComponent("Artisan ").withStyle(TextFormatting.AQUA)).append(new StringTextComponent("or ").withStyle(TextFormatting.GRAY)).append(new StringTextComponent("Treasure Hunter").withStyle(TextFormatting.AQUA)));
        ...
        ModItems.VAULT_CHARM = new BasicTooltipItem(Vault.id("vault_charm"), new Item.Properties().tab(ModItems.VAULT_MOD_GROUP).stacksTo(1), new StringTextComponent("When this charm is in your inventory").withStyle(TextFormatting.GRAY), new StringTextComponent("it will automatically void any item").withStyle(TextFormatting.GRAY), new StringTextComponent("whitelisted in the Vault Controller").withStyle(TextFormatting.GRAY), new StringTextComponent("on pickup in a Vault.").withStyle(TextFormatting.GRAY));
