...
public class ModBlocks {
    ...
    static {
        ...
        VAULT_CHEST = new VaultChestBlock(AbstractBlock.Properties.copy((AbstractBlock) Blocks.CHEST).strength(40.0f, 5.0f));
        VAULT_TREASURE_CHEST = new VaultTreasureChestBlock(AbstractBlock.Properties.copy((AbstractBlock) Blocks.CHEST).strength(-1.0f, 3600000.0f));
        VAULT_ALTAR_CHEST = new VaultChestBlock(AbstractBlock.Properties.copy((AbstractBlock) Blocks.CHEST).strength(-1.0f, 3600000.0f));
