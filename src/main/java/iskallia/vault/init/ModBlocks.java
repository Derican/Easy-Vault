...
public class ModBlocks {
    ...
    public static void registerBlocks(final RegistryEvent.Register<Block> event) {
        registerBlock(event, ModBlocks.FLOATING_TEXT, Vault.id("floating_text"));
        registerBlock(event, ModBlocks.VAULT_PORTAL, Vault.id("vault_portal"));
        registerBlock(event, ModBlocks.VAULT_CHAMPION_TROPHY, Vault.id("vault_champion_trophy"));
        registerBlock(event, ModBlocks.FINAL_VAULT_PORTAL, Vault.id("final_vault_portal"));
        ...
        registerBlock(event, ModBlocks.ALEXANDRITE_ORE, Vault.id("ore_alexandrite"));
        registerBlock(event, ModBlocks.BENITOITE_ORE, Vault.id("ore_benitoite"));
        registerBlock(event, ModBlocks.LARIMAR_ORE, Vault.id("ore_larimar"));
        registerBlock(event, ModBlocks.BLACK_OPAL_ORE, Vault.id("ore_black_opal"));
        registerBlock(event, ModBlocks.PAINITE_ORE, Vault.id("ore_painite"));
        registerBlock(event, ModBlocks.ISKALLIUM_ORE, Vault.id("ore_iskallium"));
        registerBlock(event, ModBlocks.GORGINITE_ORE, Vault.id("ore_gorginite"));
        registerBlock(event, ModBlocks.SPARKLETINE_ORE, Vault.id("ore_sparkletine"));
        registerBlock(event, ModBlocks.WUTODIE_ORE, Vault.id("ore_wutodie"));
        registerBlock(event, ModBlocks.ASHIUM_ORE, Vault.id("ore_ashium"));
        registerBlock(event, ModBlocks.BOMIGNITE_ORE, Vault.id("ore_bomignite"));
        registerBlock(event, ModBlocks.FUNSOIDE_ORE, Vault.id("ore_funsoide"));
        registerBlock(event, ModBlocks.TUBIUM_ORE, Vault.id("ore_tubium"));
        registerBlock(event, ModBlocks.UPALINE_ORE, Vault.id("ore_upaline"));
        registerBlock(event, ModBlocks.PUFFIUM_ORE, Vault.id("ore_puffium"));
        registerBlock(event, ModBlocks.ECHO_ORE, Vault.id("ore_echo"));
        registerBlock(event, ModBlocks.UNKNOWN_ORE, Vault.id("ore_unknown"));
        registerBlock(event, ModBlocks.VAULT_ROCK_ORE, Vault.id("ore_vault_rock"));
        registerBlock(event, ModBlocks.ISKALLIUM_DOOR, Vault.id("door_iskallium"));
        registerBlock(event, ModBlocks.GORGINITE_DOOR, Vault.id("door_gorginite"));
        registerBlock(event, ModBlocks.SPARKLETINE_DOOR, Vault.id("door_sparkletine"));
        registerBlock(event, ModBlocks.ASHIUM_DOOR, Vault.id("door_ashium"));
        registerBlock(event, ModBlocks.BOMIGNITE_DOOR, Vault.id("door_bomignite"));
        registerBlock(event, ModBlocks.FUNSOIDE_DOOR, Vault.id("door_funsoide"));
        registerBlock(event, ModBlocks.TUBIUM_DOOR, Vault.id("door_tubium"));
        registerBlock(event, ModBlocks.UPALINE_DOOR, Vault.id("door_upaline"));
        registerBlock(event, ModBlocks.PUFFIUM_DOOR, Vault.id("door_puffium"));
        registerBlock(event, ModBlocks.UNKNOWN_DOOR, Vault.id("door_unknown"));
        ...
        registerBlock(event, ModBlocks.VAULT_GLASS, Vault.id("vault_glass"));
        ...
        registerBlock(event, ModBlocks.KEY_PRESS, Vault.id("key_press"));
        ...
        registerBlock(event, ModBlocks.STATUE_CAULDRON, Vault.id("statue_cauldron"));
        registerBlock(event, ModBlocks.VOID_LIQUID_BLOCK, Vault.id("void_liquid"));
        registerBlock(event, ModBlocks.HOURGLASS, Vault.id("hourglass"));
        registerBlock(event, ModBlocks.SCAVENGER_CHEST, Vault.id("scavenger_chest"));
        registerBlock(event, ModBlocks.SCAVENGER_TREASURE, Vault.id("scavenger_treasure"));
        ...
        registerBlock(event, ModBlocks.ETCHING_CONTROLLER_BLOCK, Vault.id("etching_vendor_controller"));
        ...
        registerBlock(event, ModBlocks.VAULT_AIR, Vault.id("vault_air"));
    ...
    public static void registerTileEntityRenderers() {
        ClientRegistry.bindTileEntityRenderer(ModBlocks.FLOATING_TEXT_TILE_ENTITY, FloatingTextRenderer::new);
        ClientRegistry.bindTileEntityRenderer(ModBlocks.VAULT_CHAMPION_TROPHY_TILE_ENTITY, VaultChampionTrophyRenderer::new);
        ClientRegistry.bindTileEntityRenderer(ModBlocks.FINAL_VAULT_FRAME_TILE_ENTITY, FinalVaultFrameRenderer::new);
        ...
        ClientRegistry.bindTileEntityRenderer(ModBlocks.HOURGLASS_TILE_ENTITY, HourglassRenderer::new);
    ...
    public static void registerBlockItems(final RegistryEvent.Register<Item> event) {
        registerBlockItem(event, ModBlocks.FLOATING_TEXT);
        ...
        registerBlockItem(event, ModBlocks.ALEXANDRITE_ORE);
        registerBlockItem(event, ModBlocks.BENITOITE_ORE);
        registerBlockItem(event, ModBlocks.LARIMAR_ORE);
        registerBlockItem(event, ModBlocks.BLACK_OPAL_ORE);
        registerBlockItem(event, ModBlocks.PAINITE_ORE);
        registerBlockItem(event, ModBlocks.ISKALLIUM_ORE);
        registerBlockItem(event, ModBlocks.GORGINITE_ORE);
        registerBlockItem(event, ModBlocks.SPARKLETINE_ORE);
        registerBlockItem(event, ModBlocks.WUTODIE_ORE);
        registerBlockItem(event, ModBlocks.ASHIUM_ORE);
        registerBlockItem(event, ModBlocks.BOMIGNITE_ORE);
        registerBlockItem(event, ModBlocks.FUNSOIDE_ORE);
        registerBlockItem(event, ModBlocks.TUBIUM_ORE);
        registerBlockItem(event, ModBlocks.UPALINE_ORE);
        registerBlockItem(event, ModBlocks.PUFFIUM_ORE);
        registerBlockItem(event, ModBlocks.ECHO_ORE);
        registerBlockItem(event, ModBlocks.UNKNOWN_ORE);
        registerBlockItem(event, ModBlocks.VAULT_ROCK_ORE);
        registerTallBlockItem(event, ModBlocks.ISKALLIUM_DOOR);
        registerTallBlockItem(event, ModBlocks.GORGINITE_DOOR);
        registerTallBlockItem(event, ModBlocks.SPARKLETINE_DOOR);
        registerTallBlockItem(event, ModBlocks.ASHIUM_DOOR);
        registerTallBlockItem(event, ModBlocks.BOMIGNITE_DOOR);
        registerTallBlockItem(event, ModBlocks.FUNSOIDE_DOOR);
        registerTallBlockItem(event, ModBlocks.TUBIUM_DOOR);
        registerTallBlockItem(event, ModBlocks.UPALINE_DOOR);
        registerTallBlockItem(event, ModBlocks.PUFFIUM_DOOR);
        registerTallBlockItem(event, ModBlocks.UNKNOWN_DOOR);
        ...
        registerBlockItem(event, ModBlocks.VAULT_GLASS);
        ...
        registerBlockItem(event, ModBlocks.KEY_PRESS);
        ...
        registerBlockItem(event, ModBlocks.STATUE_CAULDRON, 1);
        registerBlockItem(event, ModBlocks.HOURGLASS, new HourglassBlockItem(ModBlocks.HOURGLASS));
        registerBlockItem(event, ModBlocks.SCAVENGER_CHEST, ModBlocks.SCAVENGER_CHEST_ITEM);
        registerBlockItem(event, ModBlocks.SCAVENGER_TREASURE);
        ...
        registerBlockItem(event, ModBlocks.ETCHING_CONTROLLER_BLOCK);
    ...
    static {
        ...
        VAULT_GLASS = new GlassBlock(AbstractBlock.Properties.copy(Blocks.GLASS).strength(-1.0f, 3600000.0f));
        ...
        VAULT_DIAMOND_BLOCK = new Block(AbstractBlock.Properties.copy(Blocks.DIAMOND_BLOCK));
        MAZE_BLOCK = new MazeBlock();
        PUZZLE_RUNE_BLOCK = new PuzzleRuneBlock();
        YELLOW_PUZZLE_CONCRETE = new Block(AbstractBlock.Properties.copy(Blocks.BLACK_CONCRETE));
        PINK_PUZZLE_CONCRETE = new Block(AbstractBlock.Properties.copy(Blocks.BLACK_CONCRETE));
        GREEN_PUZZLE_CONCRETE = new Block(AbstractBlock.Properties.copy(Blocks.BLACK_CONCRETE));
        BLUE_PUZZLE_CONCRETE = new Block(AbstractBlock.Properties.copy(Blocks.BLACK_CONCRETE));
        ...
        VAULT_CHEST = new VaultChestBlock(AbstractBlock.Properties.copy(Blocks.CHEST).strength(40.0f, 5.0f));
        VAULT_TREASURE_CHEST = new VaultTreasureChestBlock(AbstractBlock.Properties.copy(Blocks.CHEST).strength(-1.0f, 3600000.0f));
        VAULT_ALTAR_CHEST = new VaultChestBlock(AbstractBlock.Properties.copy(Blocks.CHEST).strength(-1.0f, 3600000.0f));
        VAULT_COOP_CHEST = new VaultChestBlock(AbstractBlock.Properties.of(Material.STONE).strength(2.0f, 3600000.0f).sound(SoundType.STONE));
        VAULT_BONUS_CHEST = new VaultChestBlock(AbstractBlock.Properties.of(Material.STONE).strength(2.0f, 3600000.0f).sound(SoundType.STONE));
        ...
        SCAVENGER_CHEST = new ScavengerChestBlock(AbstractBlock.Properties.copy(Blocks.CHEST).strength(-1.0f, 3600000.0f));
        ...
        VOID_LIQUID_BLOCK = new VoidFluidBlock(ModFluids.VOID_LIQUID, AbstractBlock.Properties.of(Material.WATER, MaterialColor.COLOR_BLACK).noCollission().randomTicks().strength(100.0f).lightLevel(state -> 15).noDrops());
        ...
        SCAVENGER_CHEST_ITEM = new BlockItem(ModBlocks.SCAVENGER_CHEST, new Item.Properties().tab(ModItems.VAULT_MOD_GROUP).setISTER(() -> VaultStackRendererProvider.INSTANCE));
        FLOATING_TEXT_TILE_ENTITY = TileEntityType.Builder.of(FloatingTextTileEntity::new, new Block[]{ModBlocks.FLOATING_TEXT}).build(null);
        VAULT_ALTAR_TILE_ENTITY = TileEntityType.Builder.of(VaultAltarTileEntity::new, new Block[]{ModBlocks.VAULT_ALTAR}).build(null);
        VAULT_CHAMPION_TROPHY_TILE_ENTITY = TileEntityType.Builder.of(VaultChampionTrophyTileEntity::new, new Block[]{ModBlocks.VAULT_CHAMPION_TROPHY}).build(null);
        FINAL_VAULT_FRAME_TILE_ENTITY = TileEntityType.Builder.of(FinalVaultFrameTileEntity::new, new Block[]{ModBlocks.FINAL_VAULT_FRAME}).build(null);
        VAULT_RUNE_TILE_ENTITY = TileEntityType.Builder.of(VaultRuneTileEntity::new, new Block[]{ModBlocks.VAULT_RUNE_BLOCK}).build(null);
        VAULT_CRATE_TILE_ENTITY = TileEntityType.Builder.of(VaultCrateTileEntity::new, new Block[]{ModBlocks.VAULT_CRATE, ModBlocks.VAULT_CRATE_CAKE, ModBlocks.VAULT_CRATE_ARENA, ModBlocks.VAULT_CRATE_SCAVENGER}).build(null);
        VAULT_PORTAL_TILE_ENTITY = TileEntityType.Builder.of(VaultPortalTileEntity::new, new Block[]{ModBlocks.VAULT_PORTAL}).build(null);
        OTHER_SIDE_PORTAL_TILE_ENTITY = TileEntityType.Builder.of(OtherSidePortalTileEntity::new, new Block[]{ModBlocks.OTHER_SIDE_PORTAL}).build(null);
        VENDING_MACHINE_TILE_ENTITY = TileEntityType.Builder.of(VendingMachineTileEntity::new, new Block[]{ModBlocks.VENDING_MACHINE}).build(null);
        ADVANCED_VENDING_MACHINE_TILE_ENTITY = TileEntityType.Builder.of(AdvancedVendingTileEntity::new, new Block[]{ModBlocks.ADVANCED_VENDING_MACHINE}).build(null);
        RELIC_STATUE_TILE_ENTITY = TileEntityType.Builder.of(RelicStatueTileEntity::new, new Block[]{ModBlocks.RELIC_STATUE}).build(null);
        LOOT_STATUE_TILE_ENTITY = TileEntityType.Builder.of(LootStatueTileEntity::new, new Block[]{ModBlocks.GIFT_NORMAL_STATUE, ModBlocks.GIFT_MEGA_STATUE, ModBlocks.VAULT_PLAYER_LOOT_STATUE, ModBlocks.OMEGA_STATUE, ModBlocks.OMEGA_STATUE_VARIANT}).build(null);
        TROPHY_STATUE_TILE_ENTITY = TileEntityType.Builder.of(TrophyStatueTileEntity::new, new Block[]{ModBlocks.TROPHY_STATUE}).build(null);
        CRYO_CHAMBER_TILE_ENTITY = TileEntityType.Builder.of(CryoChamberTileEntity::new, new Block[]{ModBlocks.CRYO_CHAMBER}).build(null);
        ANCIENT_CRYO_CHAMBER_TILE_ENTITY = TileEntityType.Builder.of(AncientCryoChamberTileEntity::new, new Block[]{ModBlocks.CRYO_CHAMBER}).build(null);
        VAULT_DOOR_TILE_ENTITY = TileEntityType.Builder.of(VaultDoorTileEntity::new, new Block[]{ModBlocks.ISKALLIUM_DOOR, ModBlocks.GORGINITE_DOOR, ModBlocks.SPARKLETINE_DOOR, ModBlocks.ASHIUM_DOOR, ModBlocks.BOMIGNITE_DOOR, ModBlocks.FUNSOIDE_DOOR, ModBlocks.TUBIUM_DOOR, ModBlocks.UPALINE_DOOR, ModBlocks.PUFFIUM_DOOR, ModBlocks.UNKNOWN_DOOR}).build(null);
        VAULT_LOOTABLE_TILE_ENTITY = TileEntityType.Builder.of(VaultLootableTileEntity::new, new Block[]{ModBlocks.UNKNOWN_ORE, ModBlocks.VAULT_LOOT_RICHITY, ModBlocks.VAULT_LOOT_RESOURCE, ModBlocks.VAULT_LOOT_MISC, ModBlocks.UNKNOWN_VAULT_CHEST, ModBlocks.UNKNOWN_TREASURE_CHEST, ModBlocks.UNKNOWN_VAULT_OBJECTIVE}).build(null);
        VAULT_CHEST_TILE_ENTITY = TileEntityType.Builder.of(VaultChestTileEntity::new, new Block[]{ModBlocks.VAULT_CHEST, ModBlocks.VAULT_ALTAR_CHEST, ModBlocks.VAULT_COOP_CHEST, ModBlocks.VAULT_BONUS_CHEST}).build(null);
        VAULT_TREASURE_CHEST_TILE_ENTITY = TileEntityType.Builder.of(VaultTreasureChestTileEntity::new, new Block[]{ModBlocks.VAULT_TREASURE_CHEST}).build(null);
        XP_ALTAR_TILE_ENTITY = TileEntityType.Builder.of(XpAltarTileEntity::new, new Block[]{ModBlocks.XP_ALTAR}).build(null);
        BLOOD_ALTAR_TILE_ENTITY = TileEntityType.Builder.of(BloodAltarTileEntity::new, new Block[]{ModBlocks.BLOOD_ALTAR}).build(null);
        TIME_ALTAR_TILE_ENTITY = TileEntityType.Builder.of(TimeAltarTileEntity::new, new Block[]{ModBlocks.TIME_ALTAR}).build(null);
        SOUL_ALTAR_TILE_ENTITY = TileEntityType.Builder.of(SoulAltarTileEntity::new, new Block[]{ModBlocks.SOUL_ALTAR}).build(null);
        STATUE_CAULDRON_TILE_ENTITY = TileEntityType.Builder.of(StatueCauldronTileEntity::new, new Block[]{ModBlocks.STATUE_CAULDRON}).build(null);
        OBELISK_TILE_ENTITY = TileEntityType.Builder.of(ObeliskTileEntity::new, new Block[]{ModBlocks.OBELISK}).build(null);
        HOURGLASS_TILE_ENTITY = TileEntityType.Builder.of(HourglassTileEntity::new, new Block[]{ModBlocks.HOURGLASS}).build(null);
        SCAVENGER_CHEST_TILE_ENTITY = TileEntityType.Builder.of(ScavengerChestTileEntity::new, new Block[]{ModBlocks.SCAVENGER_CHEST}).build(null);
        SCAVENGER_TREASURE_TILE_ENTITY = TileEntityType.Builder.of(ScavengerTreasureTileEntity::new, new Block[]{ModBlocks.SCAVENGER_TREASURE}).build(null);
        STABILIZER_TILE_ENTITY = TileEntityType.Builder.of(StabilizerTileEntity::new, new Block[]{ModBlocks.STABILIZER}).build(null);
        CATALYST_DECRYPTION_TABLE_TILE_ENTITY = TileEntityType.Builder.of(CatalystDecryptionTableTileEntity::new, new Block[]{ModBlocks.CATALYST_DECRYPTION_TABLE}).build(null);
        ETCHING_CONTROLLER_TILE_ENTITY = TileEntityType.Builder.of(EtchingVendorControllerTileEntity::new, new Block[]{ModBlocks.ETCHING_CONTROLLER_BLOCK}).build(null);
        VAULT_CHARM_CONTROLLER_TILE_ENTITY = TileEntityType.Builder.of(VaultCharmControllerTileEntity::new, new Block[]{ModBlocks.VAULT_CHARM_CONTROLLER_BLOCK}).build(null);
        RAID_CONTROLLER_TILE_ENTITY = TileEntityType.Builder.of(VaultRaidControllerTileEntity::new, new Block[]{ModBlocks.RAID_CONTROLLER_BLOCK}).build(null);
    }
