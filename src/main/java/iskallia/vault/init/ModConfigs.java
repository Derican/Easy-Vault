...
public class ModConfigs {
    ...
    public static void register() {
        ...
        ModConfigs.SAND_EVENT = new SandEventConfig().readConfig();
        ...
        ModConfigs.TREASURE_HUNT = new TreasureHuntConfig().readConfig();
        ...
        ModConfigs.RAID = new RaidConfig().readConfig();
        ...
        ModConfigs.FINAL_RAID_MODIFIER_CONFIG = new FinalRaidModifierConfig().readConfig();
        ...
        ModConfigs.EYESORE = new EyesoreConfig().readConfig();
        ModConfigs.FINAL_RAID = new FinalRaidConfig().readConfig();
        ModConfigs.FINAL_ARCHITECT = new FinalArchitectEventConfig().readConfig();
