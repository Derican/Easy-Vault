...
public class VaultAxeItem
        extends AxeItem implements VaultGear<VaultAxeItem> {
    public VaultAxeItem(ResourceLocation id, Item.Properties builder) {
        super(VaultGear.Tier.INSTANCE, 0.0F, -2.4F, builder);
        setRegistryName(id);
    }
...
/* Location:              C:\Users\Grady\Desktop\the_vault-1.7.2p1.12.4.jar!\iskallia\vault\item\gear\VaultAxeItem.class
