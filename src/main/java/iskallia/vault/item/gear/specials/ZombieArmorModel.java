...
public class ZombieArmorModel<T extends LivingEntity> extends VaultGearModel<T> {
    public ZombieArmorModel(float modelSize, EquipmentSlotType slotType) {
        super(modelSize, slotType);
        this.texWidth = isLayer2() ? 64 : 64;
        this.texHeight = isLayer2() ? 32 : 32;
...
/* Location:              C:\Users\Grady\Desktop\the_vault-1.7.2p1.12.4.jar!\iskallia\vault\item\gear\specials\ZombieArmorModel.class
