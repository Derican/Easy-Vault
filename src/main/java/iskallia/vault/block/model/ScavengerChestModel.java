...
public class ScavengerChestModel extends Model {
    ...
    public ScavengerChestModel() {
        ...
        this.texWidth = 128;
        this.texHeight = 128;
        (this.chest = new ModelRenderer(this)).setPos(0.0f, 16.0f, 0.0f);
        this.setRotationAngle(this.chest, 0.0f, 0.0f, -3.1416f);
        (this.lid = new ModelRenderer(this)).setPos(0.0f, 1.0f, -7.0f);
        ...
        (this.horn_R3_r1 = new ModelRenderer(this)).setPos(3.8366f, 3.3584f, 15.0f);
        ...
        (this.horn_R2_r1 = new ModelRenderer(this)).setPos(3.8366f, 3.3584f, 15.0f);
        ...
        (this.horn_R1_r1 = new ModelRenderer(this)).setPos(3.8366f, 3.3584f, 15.0f);
        ...
        (this.horn_L3_r1 = new ModelRenderer(this)).setPos(-3.6253f, 3.3311f, 15.0f);
        ...
        (this.horn_L2_r1 = new ModelRenderer(this)).setPos(-3.6253f, 3.3311f, 15.0f);
        ...
        (this.horn_L1_r1 = new ModelRenderer(this)).setPos(-3.6253f, 3.3311f, 15.0f);
        ...
        (this.angle_R_r1 = new ModelRenderer(this)).setPos(-0.0127f, -0.2087f, 15.4708f);
        ...
        (this.angle_L_r1 = new ModelRenderer(this)).setPos(-0.0127f, -0.2087f, 15.4708f);
        ...
        (this.nose_r1 = new ModelRenderer(this)).setPos(-0.0127f, -0.2087f, 15.4708f);
        ...
        (this.eyelarge_r1 = new ModelRenderer(this)).setPos(-0.0127f, -0.2087f, 15.7208f);
        ...
        (this.eyesmall_r1 = new ModelRenderer(this)).setPos(-1.0f, 0.8221f, 16.2055f);
        ...
        (this.bottom = new ModelRenderer(this)).setPos(0.0f, 8.0f, 0.0f);
